...
const TimerSettings = () => {
  ...
  const handleWorkingMinutesChange = (event: ChangeEvent<HTMLInputElement>) => {
  ...
  const handleShortBreakMinutesChange = (
    event: ChangeEvent<HTMLInputElement>
  ) => {
    dispatch(setUserShortBreakMinutes(+event.target.value));
    resetPomodoroTimer();
  };
  ...
  const handleLongBreakMinutesChange = (
    ...
    dispatch(setUserLongBreakMinutes(+event.target.value));
    resetPomodoroTimer();
  };

  const handleMaxCyclesChange = (event: ChangeEvent<HTMLInputElement>) => {
    dispatch(setUserMaxCycles(+event.target.value));
    resetPomodoroTimer();
  };
